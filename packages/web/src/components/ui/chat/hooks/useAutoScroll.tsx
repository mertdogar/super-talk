// Adapted from shadcn-chat (jakobhoeg/shadcn-chat, MIT). Keeps a scroll container pinned to the
// bottom as new messages arrive, unless the user has scrolled up.
